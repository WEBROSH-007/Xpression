  ...
  const services = [
    {
      ...
      title: 'UX/UI Design',
      description: 'In our front end web development path, we study the target audience, and create user-friendly journeys followed by implementing an elegant interface.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-12 h-12">
      ...
      title: 'Architecture',
      description: 'AlgorithmX\'s front end development solution architects are responsible for planning components, selecting right technology for a project and aligning them with the APIs.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-12 h-12">
      ...
      description: 'Our experienced front end developers leverage JavaScript frameworks, such as Next, Meteor, React, Angular, Vue, and Ember to implement designs.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-12 h-12">
      ...
      description: 'Our talented developers build the business logic for web applications using a variety of programming languages and frameworks like .NET, Python, Node.js, Java, PHP, and Go.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-12 h-12">
      ...
      description: 'During front end web development, we perform thorough testing by integrating APIs to ensure seamless data synchronization providing a secure and user-friendly web solution.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-12 h-12">
      ...
      description: 'Our leading Front end development company, AlgorithmX, continuously and rapidly improves your website software by offering updates in a matter of days and providing new features every few weeks through streamlined DevOps practices.'
    }
  ];
