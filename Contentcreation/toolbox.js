...
const TechnologyToolbox = () => {
  const tools = [
    { id: 'ps', name: 'Adobe Font', image: 'images/Adobe.png' },
    { id: 'ai', name: 'Creative Cloud', image: 'images/illustrator.png' },
    { id: 'ae', name: 'Ahrefs', image: 'images/after-effects.png' },
    { id: 'id', name: 'ChatGPT', image: 'images/indesign.png' },
    { id: 'canva', name: 'Claude', image: 'images/canva.png' },
    { id: 'figma', name: 'Google Analytics', image: 'images/figma.png' },
    { id: 'cs', name: 'Google Font', image: 'images/creative-suite.png'},
    { id: 'stock', name: 'Grammerly', image: 'images/stock.png' },
    { id: 'sketch', name: 'Hemingway Editor', image: 'images/sketch.png'},
    { id: 'word', name: 'Microsoft Word', image: 'images/sketch.png'},
    { id: 'oa', name: 'Originality AI', image: 'images/sketch.png'},
    { id: 'per', name: 'Perplexity', image: 'images/sketch.png'},
    { id: 'scr', name: 'Scrivener', image: 'images/sketch.png'},
    { id: 'sem', name: 'SEMrush', image: 'images/sketch.png'},
  ];
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 text-center text-xl sm:text-xl mb-8 sm:mb-16 max-w-5xl mx-auto px-2">
