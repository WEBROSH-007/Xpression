...
const ServiceCard = ({ title, description }) => (
  <div className="relative flex-1 p-6 bg-black rounded-lg min-w-[250px] overflow-visible">
    {/* Border container */}
    ...
    <div className="absolute -top-3 left-0 w-full flex justify-center">
      <span className="bg-black px-4 text-white border border-blue-600 rounded-md whitespace-nowrap">
        {title}
      </span>
    </div>
    {/* Content */}
