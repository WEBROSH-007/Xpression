...
const TechnologyToolbox = () => {
  const tools = [
    { id: 'ps', name: 'Premier Pro', image: 'images/Adobe.png' },
    { id: 'ai', name: 'Animate', image: 'images/illustrator.png' },
    { id: 'ae', name: 'After Effects', image: 'images/after-effects.png' },
    { id: 'id', name: 'Auto Desk', image: 'images/indesign.png' },
    { id: 'canva', name: 'Cinema 4D', image: 'images/canva.png' },
    { id: 'figma', name: 'Final Cut Pro', image: 'images/figma.png' },
    { id: 'cs', name: 'Maya', image: 'images/creative-suite.png'},
    { id: 'stock', name: 'Moho', image: 'images/stock.png' }
  ];
