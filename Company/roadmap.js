...
const Roadmap = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-black text-white">
      ...
      <div className="w-full mx-3 md:w-1/3 top-0 md:sticky content-center flex flex-col justify-center px-4 lg:px-10">
      ...
      {/* Right Section */}
      <div className="w-full md:w-2/3 relative px-4 lg:px-10 py-10 md:h-screen overflow-y-auto your-scrollable-div">
