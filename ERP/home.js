      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-16">
          ...
          <div className="w-full md:w-2/3 flex flex-col  space-y-6">
            ...
            />
            <h1 className="text-4xl md:text-7xl tracking-wider bg-white-500 ">
              ERP
            </h1>
            <h1 className="text-4xl md:text-7xl  tracking-wider bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 bg-clip-text text-transparent font-light">
             DEVELOPMENT
            </h1>
          </div>
        </div>
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          AlgorithmX is a leading provider of top-notch ERP development services where we build a centralized platform for your business’s optimal performance. Our custom ERP development solutions cover everything from HR and finance to CRM, and supply chain, unifying your processes.
          </p>
        </div>
      </div>
    </div>
