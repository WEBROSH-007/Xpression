    ...
    <div className="min-h-screen bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="bg-black rounded-3xl p-8 md:p-12 border border-zinc-800">
          <h1 className="text-4xl sm:text-4xl font-light mb-6">
            Streamlining CRM Development
          </h1>
          <p className="text-zinc-400 text-base sm:text-md mb-10">
          ...
          <div className="relative">
            <div className="grid grid-cols-1 md:grid-cols-8 gap-6 md:gap-0">
              ...
              <div className="relative col-span-full mb-16">
                ...
                <div className="hidden md:block absolute left-[0.5%] right-[1%] h-0.5 top-14">
              ...
              {/* Second row - items 5-7 */}
              <div className="relative col-span-full">
                {/* Timeline for second row */}
                <div className="hidden md:block absolute left-[0.5%] right-[45%] h-0.5 top-14">
